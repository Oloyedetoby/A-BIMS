...
from .serializers import CreditNoteWriteSerializer
...
class AuthorViewSet(viewsets.ModelViewSet): # <-- THIS IS THE CHANGE
    """
    A simple ViewSet for listing, creating, editing, and deleting authors.
    """
...
class InvoiceViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        # THIS IS THE CORRECTED SUBQUERY
